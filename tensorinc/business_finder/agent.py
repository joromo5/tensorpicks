...
from tensorinc.business_finder.validator import (
    validate,
    format_validation,
)
from tensorinc.business_finder.trends import (
...
class BusinessFinderAgent(Agent):
    ...
    def run(self) -> None:
        ...
        for opp in top3:
            v = validate(opp)
            if v:
                from tensorinc.business_finder.database import update_validation
